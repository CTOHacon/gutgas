		...
		<div class="row">
			<div class="col-9">
				...
				<FormFieldWrapper
					...
					class="mb-3"
				>
					<FaqEditBlock v-model="pageForm.meta.faqItems" />
				</FormFieldWrapper>
			</div>
			<div class="col-3">
...
import FaqEditBlock from '@/AdminComponents/ContentBlocks/FaqEditBlock.vue';
...
const pageForm = useForm<TPageForm>({
	...
	meta: {
		contentTitle: getMeta<string>(props.page.meta, 'contentTitle') ?? '',
		faqItems: getMeta<TFaqItemProps[]>(props.page.meta, 'faqItems') ?? []
	},
